...
"""
 ...
 #el simbolo igual= guarda el valor y lo asigna a una variable n=10 n+=5 n=n+5 n-=5 n/=2 n*2 realian operaciones con numeros ya agragados
# < menor que, > mayor que, >= mayor igual que. <= menor igual que, !=, == igual e igual 
